...
| <a name="input_crds_depends_on"></a> [crds\_depends\_on](#input\_crds\_depends\_on) | List of resources to wait for before installing the addon. Typically used to force a dependency on another addon. | `any` |
