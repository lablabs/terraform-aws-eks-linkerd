...
locals {
  # CA and issuer certificate can be generated by following this manual https://linkerd.io/2.11/tasks/generate-certificates/#generating-the-certificates-with-step
  values = yamlencode({
